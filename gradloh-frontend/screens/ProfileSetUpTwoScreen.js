...
import { View, Text, StyleSheet, Image, TextInput, Pressable, TouchableOpacity, Platform, TouchableNativeFeedback, ActivityIndicator, LogBox  } from "react-native";
    ...
    const handleSubmit = async () => {
        ...
        if (!majorValue) {
          ...
          if (isSelectedSecondMajor) {
            ...
            if (isSelectedMinor) { //If only select minor
