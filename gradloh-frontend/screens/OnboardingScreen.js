...
export default function OnboardingOneScreen() {
  ...
  return (
    <View style={styles.container}>
        <Onboarding
            DoneButtonComponent={(props) => <CustomDoneButton {...props} title="Done" backgroundColor="#ffffff" fadeInDuration={500} />}
            NextButtonComponent={(props) => <CustomNextButton {...props} nextLabel="Next" backgroundColor="#ffffff" />}
            SkipButtonComponent={(props) => <CustomNextButton {...props} nextLabel="Skip" backgroundColor="#ffffff" />}
            ...
            pages={[
                {
                    ...
                    subtitle: "Start your graduation journey with these powerful features.",
                ...
                },
                {
                    ...
                    subtitle: "Interactive and informative charts to ensure that you graduate on time.",
                    titleStyles : styles.welcomeTitle,
                    subTitleStyles: styles.welcomeText
                },
                {
                    ...
                    subtitle: "Easily manage and populate your modules all in one place.",
                    titleStyles : styles.welcomeTitle,
                    subTitleStyles: styles.welcomeText
                },
                {
                    ...
                    title: "Henry",
                    subtitle: "Your smart assistant, designed to give personalized suggestions based on your preferences.",
                    titleStyles : styles.welcomeTitle,
                    subTitleStyles: styles.welcomeText
                },
                {
